...
// Deliberately NOT using the shadcn Accordion component here — it's the
// only place in the app that would import @radix-ui/react-accordion, and
// pulling that package into the SSR bundle for the first time crashes the
// server entry (a circular-chunk bug in the current beta Nitro/Vite/
// Rolldown stack — see docs/SSR_BUNDLER_BUG.md). Plain <details>/<summary>
// gives the same collapsible behavior with zero extra dependencies.
