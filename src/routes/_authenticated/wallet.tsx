...
import { AlertTriangle, ArrowDownToLine, ArrowUpFromLine, Copy, Loader2, Lock, Repeat, Zap } from "lucide-react";
    ...
    <div className="mx-auto w-full max-w-[1400px] px-4 py-6">
      <div className="mb-6 flex flex-wrap items-start justify-between gap-3">
        ...
        <Button variant="outline" size="sm" asChild>
          <Link to="/swap" className="gap-1.5">
            <Repeat className="size-4" /> Swap between coins
          </Link>
        </Button>
      </div>
