// ISO 3166-1 alpha-2 codes + common English names — every UN member state
// plus commonly-recognized territories/entities (Hong Kong, Macao, Taiwan,
// Kosovo, Palestine, Vatican City), used for the register-page country field
// and for offer country targeting/filtering.
